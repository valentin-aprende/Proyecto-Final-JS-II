...
if (!res.ok) throw new Error();*/ /*} catch (err) {

alert(err);*/ async function controlRecipe() {
    try {
    ...
    console.log(data);
    console.log(resp);*/ /*const markup = `<figure class="recipe__fig">
    ...
    <li class="recipe__ingredient">
     <svg class="recipe__icon">
      ...
      <div class="recipe__description">
        ...
        </div>`*/ /*recipeContainer.innerHTML = "";

    recipeContainer.insertAdjacentHTML('afterbegin', markup);*/ } catch (err) {
...
},{"fraction.js":"md6n5","./View.js":"jSw21","a0b82650a605f976":"aob6l","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"md6n5":[function(require,module,exports,__globalThis) {
/*
...
},{"./View":"jSw21","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"CYzq3":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./View":"jSw21","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fd0vu":[function(require,module,exports,__globalThis) {
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (curPage === 1 && numPages > 1) return `
                ...
                <svg class="search__icon">
                    <use>${icons}#icon-arrow-right</use>
                </svg>
                </button>
            `;
